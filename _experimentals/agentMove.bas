...
Dim sel As Visio.Selection
    ...
    'Рабочий вариант: Application.ActivePage.SpatialSearch(x, y, VisSpatialRelationCodes.visSpatialContainedIn, 0, visSpatialFrontToBack) - содержится в очертаниях фигуры
