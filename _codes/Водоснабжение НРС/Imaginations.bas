...
Set ShapeFrom = Application.Documents("Водоснабжение НРС.vss").Masters("Открытый водоисточник").Shapes(1)
IDTo = ShapeTo.ID
IDFrom = Application.Documents("Водоснабжение НРС.vss").Masters("Открытый водоисточник").Index
...
Set ShapeFrom = Application.Documents("Водоснабжение НРС.vss").Masters(ShapeFromID).Shapes(1) 'Application.ActivePage.Shapes.ItemFromID(ShapeFromID)
...
'---Присваиваем объектным переменным Фигуры(ShapeFrom и ShpeTo) в соответствии с индексами
Set ShapeFrom = Application.Documents("Водоснабжение НРС.vss").Masters(ShapeFromID).Shapes(1)
Set ShapeTo = Application.ActivePage.Shapes.ItemFromID(ShapeToID)
...
'MsgBox Application.Documents("Водоснабжение НРС.vss").Masters(ShapeFromID).Name
