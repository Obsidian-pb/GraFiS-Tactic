...
'---Показываем окно свойств Водоснабжение_НР
...
'---Импортируем мастера
    MasterImportSub "Водоснабжение НРС.vss", "Водоем1_Мелкий"
    MasterImportSub "Водоснабжение НРС.vss", "Водоем1_Средний"
'    MasterImportSub "Водоснабжение НРС.vss", "Водоем1_Средний" ВИ_Емкость
