...
BEGIN
  MultiUse = -1  'True
END
Attribute VB_Name = "Form_Гидроэлеваторы"
...
'---Блокируем элементы управления
    ...
    ПФ_ПроизводительностьГЭ.Locked = Not Me.Controls("В_РедактироватьДанные").Value 'Изменяем состояние блокировки элемента в соответствии с состоянием выключателя
