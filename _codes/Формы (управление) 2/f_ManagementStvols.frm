VERSION 5.00
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} f_ManagementStvols 
   Caption         =   "UserForm2"
   ClientHeight    =   2955
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   13125
   OleObjectBlob   =   "f_ManagementStvols.frx":0000
   StartUpPosition =   1  'CenterOwner
End
Attribute VB_Name = "f_ManagementStvols"
...
'---Выполняем сортировку
    ...
    ElseIf ColumnNumber = 5 Then
        ...
        For i = 1 To Me.ListView1.ListItems.Count 'первое число
            ...
            Next j
        Next i
    ElseIf ColumnNumber = 6 Or ColumnNumber = 8 Then
        'Для чисел
        For i = 1 To Me.ListView1.ListItems.Count 'первое число
            For j = i To Me.ListView1.ListItems.Count 'второе число
