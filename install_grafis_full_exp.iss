...
Source: "Цветовые схемы\БУПО-2017 (красная).vsd"; DestDir: "{app}\Цветовые схемы\"; Flags: ignoreversion; components: traf traf_nrs
Source: "Цветовые схемы\БУПО-2017 (красно-синяя) + ГОСТ.vsd"; DestDir: "{app}\Цветовые схемы\"; Flags: ignoreversion; components: traf traf_nrs
Source: "Цветовые схемы\БУПО-2017 (красно-синяя).vsd"; DestDir: "{app}\Цветовые схемы\"; Flags: ignoreversion; components: traf traf_nrs
Source: "Цветовые схемы\БУПО-2017 (красно-черная) + ГОСТ.vsd"; DestDir: "{app}\Цветовые схемы\"; Flags: ignoreversion; components: traf traf_nrs
Source: "Цветовые схемы\БУПО-2017 (красно-черная).vsd"; DestDir: "{app}\Цветовые схемы\"; Flags: ignoreversion; components: traf traf_nrs
Source: "Цветовые схемы\Сине-серая школьная доска - ГОСТ.vsd"; DestDir: "{app}\Цветовые схемы\"; Flags: ignoreversion; components: traf traf_nrs
Source: "Цветовые схемы\Черная школьная доска - ГОСТ.vsd"; DestDir: "{app}\Цветовые схемы\"; Flags: ignoreversion; components: traf traf_nrs
Source: "Цветовые схемы\Черная.vsd"; DestDir: "{app}\Цветовые схемы\"; Flags: ignoreversion; components: traf traf_nrs
